 ...
 * Uses the same AVAudioEngine approach as OmniRealtimeService for playback
 */
...
class TTSService: NSObject, ObservableObject {
    ...
    private func configureAudioSession() {
        do {
            ...
            // Only configure when needed to avoid conflicts with existing sessions
            // Use exactly the same settings as OmniRealtimeService (no defaultToSpeaker)
            ...
            // Don't throw error, try to use existing session for playback
        }
    }
    ...
    private func startPlaybackEngine() {
        ...
        do {
            ...
            print("❌ [TTS] Playback engine start failed: \(error)")
        }
    }
    ...
    private func synthesizeAndPlay(text: String, apiKey: String) async throws {
        ...
        // Call play() early to prepare playerNode for receiving buffers
        playerNode?.play()
            ...
            if line.hasPrefix("data:") {
                ...
                if let jsonData = jsonString.data(using: .utf8),
                   ...
                   !audioData.isEmpty {
                    ...
                    // Stream playback of each audio chunk
    ...
    private func createPCMBuffer(from data: Data, format: AVAudioFormat) -> AVAudioPCMBuffer? {
        ...
        data.withUnsafeBytes { (bytes: UnsafeRawBufferPointer) in
            ...
            for i in 0..<frameCount {
                // Convert Int16 range -32768 to 32767 to -1.0 to 1.0
    ...
    private func waitForPlaybackCompletion() async {
        ...
        // Additional wait to ensure complete playback
    ...
    private func fallbackToSystemTTS(text: String) async {
        ...
        let voiceLanguage = LanguageManager.staticIsRomanian ? "ro-RO" : "en-US"
        ...
        // Wait briefly to let playback start
