 ...
 * Fast image recognition service - Supports multiple providers (Alibaba Cloud/OpenRouter)
...
class QuickVisionService {
    ...
    /// Fast image recognition - Returns concise voice description
    /// - Parameters:
...
enum QuickVisionError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .frameTimeout:
            return "Video frame timeout, please try again"
        case .invalidImage:
