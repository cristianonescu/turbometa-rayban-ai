...
class LiveAIModeManager: ObservableObject {
    ...
    private init() {
        ...
        // Load translation target language (default follows system language)
    ...
    /// Get the complete system prompt for the current mode
    ...
    /// Get translation mode prompt (includes target language)
    ...
    /// Whether to automatically send an image when voice is triggered
