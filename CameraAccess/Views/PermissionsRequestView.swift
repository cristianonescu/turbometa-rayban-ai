 ...
 * Permission request interface when the app launches
 */
        ...
        ZStack {
            ...
            VStack(spacing: AppSpacing.xl) {
                ...
                VStack(spacing: AppSpacing.sm) {
                    Text("Your Authorization Required")
                ...
                VStack(spacing: AppSpacing.md) {
                    ...
                    PermissionRow(
                        icon: "photo.fill",
                        title: "Photos",
                        description: "Save photos taken by glasses"
                    )
                }
                .padding(.horizontal, AppSpacing.xl)
                ...
                VStack(spacing: AppSpacing.md) {
                    if isRequesting {
                        ...
                        VStack(spacing: AppSpacing.sm) {
                            Text("Some permissions not granted")
