/*
 * Records View
 * Records Page - Contains tabs for various types of records
 */
            ...
            VStack(spacing: 0) {
                ...
                ScrollView(.horizontal, showsIndicators: false) {
                    HStack(spacing: AppSpacing.lg) {
                        ...
                        RecordTabButton(title: "Real-time Translation", isSelected: selectedTab == 1) {
                            selectedTab = 1
                        }
        ...
        ZStack {
            ...
            if viewModel.conversations.isEmpty {
                ...
                VStack(spacing: AppSpacing.lg) {
                    ...
                    Text("No Live AI conversation records yet")
                        .font(AppTypography.title2)
                        .foregroundColor(AppColors.textPrimary)

                    Text("After using Live AI, your records will appear here")
                        .font(AppTypography.subheadline)
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: AppSpacing.lg) {
                ...
                Text("No calorie recognition records yet")
                    .font(AppTypography.title2)
                    .foregroundColor(AppColors.textPrimary)
