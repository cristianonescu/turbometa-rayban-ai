     ...
     VStack(spacing: AppSpacing.xl) {
       ...
       VStack(spacing: AppSpacing.md) {
         FeatureTipView(
           icon: "video.fill",
           title: "Live Video",
           text: "Record video directly from glasses perspective, capture what you see and hear"
         )
         FeatureTipView(
           icon: "brain.head.profile",
           title: "AI Conversation",
           text: "Real-time AI assistant, providing intelligent help anytime, anywhere"
         )
         FeatureTipView(
           icon: "waveform",
           title: "Open Audio",
           text: "Keep your ears open to the world while receiving notifications"
         )
       }
       ...
       // Connection Button
       VStack(spacing: AppSpacing.md) {
         Text("Will redirect to Meta AI app to confirm connection")
