 ...
 * Simplified live stream view - for platforms like TikTok/Douyin, Kuaishou, etc.
 */
            ...
            if showUI {
                VStack {
                    ...
                    VStack(spacing: AppSpacing.md) {
                        Text("Live Stream Instructions")
                            .font(AppTypography.headline)
                            .foregroundColor(.white)

                        Text("1. Open TikTok/Douyin or Kuaishou live platform")
                            .font(AppTypography.caption)
                            .foregroundColor(.white.opacity(0.8))

                        Text("2. Select screen recording function")
                            .font(AppTypography.caption)
                            .foregroundColor(.white.opacity(0.8))
