    ...
    var body: some View {
        NavigationView {
            ...
            .onChange(of: showAPIKeySettings) { isShowing in
                // Refresh status when API Key settings sheet closes
                if !isShowing {
                    refreshAPIKeyStatus()
                }
            }
            ...
            .onChange(of: showGoogleAPIKeySettings) { isShowing in
                // Refresh status when Google API Key settings sheet closes
                if !isShowing {
                    refreshAPIKeyStatus()
                }
            }
        ...
        NavigationView {
            List {
                Section {
                    ...
                    Text("AI will use this language for both voice output and text replies.")
                }
            }
