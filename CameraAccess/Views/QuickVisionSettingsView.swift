 ...
 * Quick image recognition settings - Mode selection, custom prompts, history
 */
...
struct QuickVisionSettingsView: View {
    ...
    var body: some View {
        NavigationView {
            List {
                // Image recognition mode selection
                Section {
                ...
                // Translation target language (show only in translate mode)
                ...
                // Custom prompt (show only in custom mode)
